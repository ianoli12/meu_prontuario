...
class Ui_Form_principal(object):
    def setupUi(self, Form_principal):
        ...
        Form_principal.setStyleSheet(u"background-color: rgb(111, 8, 255);")
        self.verticalLayout = QVBoxLayout(Form_principal)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.label = QLabel(Form_principal)
        ...
        self.frame = QFrame(Form_principal)
        ...
        self.Pages = QStackedWidget(Form_principal)
        self.Pages.setObjectName(u"Pages")
        self.pg_painel = QWidget()
        self.pg_painel.setObjectName(u"pg_painel")
        self.pg_painel.setEnabled(False)
        ...
        self.pg_prontuarios.setEnabled(False)
        ...
        self.btn_pg_cadastro = QPushButton(Form_principal)
    ...
    def retranslateUi(self, Form_principal):
        ...
        self.label.setText(QCoreApplication.translate("Form_principal", u"Meu Prontu\u00e1rio", None))
        self.btn_painel.setText(QCoreApplication.translate("Form_principal", u"PAINEL", None))
        self.btn_agenda.setText(QCoreApplication.translate("Form_principal", u"AGENDA", None))
        self.btn_prontuarios.setText(QCoreApplication.translate("Form_principal", u"PRONTU\u00c1RIOS", None))
        self.btn_sobre.setText(QCoreApplication.translate("Form_principal", u"SOBRE", None))
        self.label_14.setText(QCoreApplication.translate("Form_principal", u"PAINEL", None))
        self.label_6.setText(QCoreApplication.translate("Form_principal", u"Total de Pacientes:", None))
        self.label_7.setText(QCoreApplication.translate("Form_principal", u"Pacientes Confirmados:", None))
        self.label_5.setText(QCoreApplication.translate("Form_principal", u"Pacientes Atendidos:", None))
        self.lb_pac_total.setText(QCoreApplication.translate("Form_principal", u"TextLabel", None))
        self.lb_pac_confirmados.setText(QCoreApplication.translate("Form_principal", u"TextLabel", None))
        self.lb_pac_atendidos.setText(QCoreApplication.translate("Form_principal", u"TextLabel", None))
        self.label_20.setText(QCoreApplication.translate("Form_principal", u"PRONTU\u00c1RIOS", None))
        self.label_19.setText(QCoreApplication.translate("Form_principal", u"Rela\u00e7\u00e3o de Prontu\u00e1rios", None))
        ___qtreewidgetitem = self.treeWidget.headerItem()
        ___qtreewidgetitem.setText(3, QCoreApplication.translate("Form_principal", u"CONV\u00caNIO", None));
        ___qtreewidgetitem.setText(2, QCoreApplication.translate("Form_principal", u"TELEFONE", None));
        ___qtreewidgetitem.setText(1, QCoreApplication.translate("Form_principal", u"NOME", None));
        ___qtreewidgetitem.setText(0, QCoreApplication.translate("Form_principal", u"C\u00d3DIGO", None));
        self.pushButton_3.setText(QCoreApplication.translate("Form_principal", u"PushButton", None))
        self.pushButton.setText(QCoreApplication.translate("Form_principal", u"Adicionar Paciente", None))
        self.pushButton_2.setText(QCoreApplication.translate("Form_principal", u"Excluir", None))
        self.label_25.setText(QCoreApplication.translate("Form_principal", u"CADASTRO", None))
        self.label_26.setText(QCoreApplication.translate("Form_principal", u"Cadastro de Usu\u00e1rios:", None))
        self.label_3.setText(QCoreApplication.translate("Form_principal", u"C\u00f3digo:", None))
        self.label_30.setText(QCoreApplication.translate("Form_principal", u"Nome:", None))
        self.label_28.setText(QCoreApplication.translate("Form_principal", u"Telefone:", None))
        self.label_29.setText(QCoreApplication.translate("Form_principal", u"Endere\u00e7o:", None))
        self.label_2.setText(QCoreApplication.translate("Form_principal", u"E-mail:", None))
        self.label_27.setText(QCoreApplication.translate("Form_principal", u"Conv\u00eanio:", None))
        self.label_18.setText(QCoreApplication.translate("Form_principal", u"Usu\u00e1rio:", None))
        self.label_4.setText(QCoreApplication.translate("Form_principal", u"Senha:", None))
        self.label_17.setText(QCoreApplication.translate("Form_principal", u"Acesso", None))
        self.cb_acesso.setItemText(0, QCoreApplication.translate("Form_principal", u"USUARIO", None))
        self.cb_acesso.setItemText(1, QCoreApplication.translate("Form_principal", u"ADMINISTRADOR", None))

        self.btn_cadastrar_usu.setText(QCoreApplication.translate("Form_principal", u"Cadastrar", None))
        self.btn_pg_cadastro.setText(QCoreApplication.translate("Form_principal", u"CADASTRAR USUARIO", None))
    # retranslateUi
